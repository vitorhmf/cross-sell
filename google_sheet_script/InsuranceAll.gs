function onOpen() {
  ...
  ui.createMenu('Insurance All')
    .addItem('Get Propensity Score', 'PropensityScore')    
    .addToUi()
}

// Helper Function

host_production = 'insurance-all-vhmf.herokuapp.com'
...
// Insurance All Propensity Score Prediction
